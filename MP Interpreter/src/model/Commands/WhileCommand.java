...
public class WhileCommand implements IControlledCommand  {
    ...
    public WhileCommand(TerminalNode variableUB, PseudoCodeParser.ExpressionContext exprLB, String iteration){
    ...
    public WhileCommand(TerminalNode variableUB, PseudoCodeParser.ExpressionContext arrAccess, PseudoCodeParser.ExpressionContext exprLB, String iteration){
        this.variableUB = variableUB;
        this.exprLB = exprLB;
    ...
    public void execute() {
        ...
        try {
            while(evaluateCondition()) {
                for(ICommand command : this.whilestatement) {
